...
Consider you're an experienced AI Architect.  Create a very good innovative Agentic AI conversational Chat bot with the enterprise UI.  The Application name is "RTF DP&E Ops Nexus".  The entire project will be using the Claude Sonnet model and developed with the frame work of CLAUDE Code.
